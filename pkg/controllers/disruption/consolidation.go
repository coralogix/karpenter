...
func MakeConsolidation(clock clock.Clock, cluster *state.Cluster, kubeClient client.Client, provisioner *provisioning.Provisioner,
	cloudProvider cloudprovider.CloudProvider, recorder events.Recorder, queue *Queue, underutilizedPace *UnderutilizedConsolidationPace) consolidation {
...
//
// nolint:gocyclo
func (c *consolidation) computeConsolidation(ctx context.Context, simulator *SchedulingSimulator, candidates ...*Candidate) (Command, error) {
	var err error
	// Run scheduling simulation to compute consolidation option
	results, err := simulator.Simulate(ctx, candidates...)
	if err != nil {
